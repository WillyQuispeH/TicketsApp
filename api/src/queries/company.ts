const _getAll = `SELECT id, rut, companyname, legalrepresentative, line, email, phone, address, district FROM app.company;`;

const _create = `INSERT INTO app.company 
